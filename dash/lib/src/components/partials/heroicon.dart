...
/// Heroicon component for rendering icons.
///
/// Supports both solid and outline variants from heroicons.com.
/// Inherits default size and color from [DefaultIconStyle] if present in the tree.
///
/// Example:
/// ```dart
/// Heroicon(HeroIcons.userGroup, style: HeroIconStyle.solid)
/// Heroicon(HeroIcons.cog, size: 20, color: 'text-blue-500')
/// ```
class Heroicon extends StatelessComponent {
  ...
  /// Icon size in pixels. Falls back to [DefaultIconStyle.size] or 24.
  final int? size;

  /// Icon color as Tailwind class. Falls back to [DefaultIconStyle.color] or 'currentColor'.
  final String? color;

  const Heroicon(this.icon, {this.style = HeroIconStyle.outline, this.className, this.size, this.color, super.key});

  @override
  Component build(BuildContext context) {
    final pathData = style == HeroIconStyle.solid ? _solidPaths[icon] : _outlinePaths[icon];

    if (pathData == null) {
      return span([text('?')]);
    }

    // Resolve size and color from props or inherited defaults
    final defaults = DefaultIconStyle.maybeOf(context);

    final resolvedSize = size ?? defaults?.size ?? 24;
    final resolvedColor = color ?? defaults?.color;

    final fillAttr = style == HeroIconStyle.solid ? 'fill="currentColor"' : 'fill="none"';
    ...
    if (className != null) {
      ...
      classes.add('w-[$resolvedSize px] h-[$resolvedSize px]');
    }
    if (resolvedColor != null) {
      classes.add(resolvedColor);
    }

    final classAttr = classes.isNotEmpty ? 'class="${classes.join(' ')}"' : '';
    final sizeAttrs = 'width="$resolvedSize" height="$resolvedSize"';

    return raw(
      '<svg $classAttr xmlns="http://www.w3.org/2000/svg" $fillAttr viewBox="0 0 24 24" $sizeAttrs stroke-width="1.5" stroke="currentColor">$pathData</svg>',
    );
  }
}
...
/// Outline icon paths
const Map<HeroIcons, String> _outlinePaths = {
  ...
  HeroIcons.arrowLeft: '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"/>',
  ...
  HeroIcons.bars2: '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9h16.5m-16.5 6.75h16.5"/>',
  HeroIcons.bars3:
  ...
  HeroIcons.check: '<path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/>',
  ...
  HeroIcons.chevronDoubleUp:
      '<path stroke-linecap="round" stroke-linejoin="round" d="m4.5 18.75 7.5-7.5 7.5 7.5"/> <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 7.5-7.5 7.5 7.5"/>',
  HeroIcons.chevronDown: '<path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5"/>',
  HeroIcons.chevronLeft: '<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5"/>',
  HeroIcons.chevronRight: '<path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"/>',
  HeroIcons.chevronUp: '<path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5"/>',
  ...
  HeroIcons.documentCurrencyBangladeshi:
  ...
  HeroIcons.documentCurrencyDollar:
  ...
  HeroIcons.documentCurrencyPound:
  ...
  HeroIcons.documentCurrencyRupee:
  ...
  HeroIcons.equals: '<path stroke-linecap="round" stroke-linejoin="round" d="M4.499 8.248h15m-15 7.501h15"/>',
  ...
  HeroIcons.minus: '<path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14"/>',
  HeroIcons.minusCircle:
      '<path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>',
  HeroIcons.minusSmall: '<path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6"/>',
  HeroIcons.moon:
  ...
  HeroIcons.pause: '<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5"/>',
  ...
  HeroIcons.plus: '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>',
  HeroIcons.plusCircle:
      '<path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>',
  HeroIcons.plusSmall: '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6"/>',
  HeroIcons.power: '<path stroke-linecap="round" stroke-linejoin="round" d="M5.636 5.636a9 9 0 1 0 12.728 0M12 3v9"/>',
  ...
  HeroIcons.slash: '<path stroke-linecap="round" stroke-linejoin="round" d="m9 20.247 6-16.5"/>',
  HeroIcons.sparkles:
  ...
  HeroIcons.stopCircle:
      '<path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/> <path stroke-linecap="round" stroke-linejoin="round" d="M9 9.563C9 9.252 9.252 9 9.563 9h4.874c.311 0 .563.252.563.563v4.874c0 .311-.252.563-.563.563H9.564A.562.562 0 0 1 9 14.437V9.564Z"/>',
  ...
  HeroIcons.xMark: '<path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/>',
};

/// Solid icon paths
const Map<HeroIcons, String> _solidPaths = {
  HeroIcons.academicCap:
  ...
  HeroIcons.banknotes:
      '<path d="M12 7.5a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z"/> <path fill-rule="evenodd" d="M1.5 4.875C1.5 3.839 2.34 3 3.375 3h17.25c1.035 0 1.875.84 1.875 1.875v9.75c0 1.036-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 0 1 1.5 14.625v-9.75ZM8.25 9.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM18.75 9a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V9.75a.75.75 0 0 0-.75-.75h-.008ZM4.5 9.75A.75.75 0 0 1 5.25 9h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V9.75Z" clip-rule="evenodd"/> <path d="M2.25 18a.75.75 0 0 0 0 1.5c5.4 0 10.63.722 15.6 2.075 1.19.324 2.4-.558 2.4-1.82V18.75a.75.75 0 0 0-.75-.75H2.25Z"/>',
  HeroIcons.bars2:
  ...
  HeroIcons.magnifyingGlassCircle:
      '<path d="M8.25 10.875a2.625 2.625 0 1 1 5.25 0 2.625 2.625 0 0 1-5.25 0Z"/> <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.125 4.5a4.125 4.125 0 1 0 2.338 7.524l2.007 2.006a.75.75 0 1 0 1.06-1.06l-2.006-2.007a4.125 4.125 0 0 0-3.399-6.463Z" clip-rule="evenodd"/>',
  HeroIcons.magnifyingGlassMinus:
  ...
  HeroIcons.microphone:
      '<path d="M8.25 4.5a3.75 3.75 0 1 1 7.5 0v8.25a3.75 3.75 0 1 1-7.5 0V4.5Z"/> <path d="M6 10.5a.75.75 0 0 1 .75.75v1.5a5.25 5.25 0 1 0 10.5 0v-1.5a.75.75 0 0 1 1.5 0v1.5a6.751 6.751 0 0 1-6 6.709v2.291h3a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5h3v-2.291a6.751 6.751 0 0 1-6-6.709v-1.5A.75.75 0 0 1 6 10.5Z"/>',
  HeroIcons.minus:
  ...
  HeroIcons.serverStack:
      '<path d="M5.507 4.048A3 3 0 0 1 7.785 3h8.43a3 3 0 0 1 2.278 1.048l1.722 2.008A4.533 4.533 0 0 0 19.5 6h-15c-.243 0-.482.02-.715.056l1.722-2.008Z"/> <path fill-rule="evenodd" d="M1.5 10.5a3 3 0 0 1 3-3h15a3 3 0 1 1 0 6h-15a3 3 0 0 1-3-3Zm15 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm2.25.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5ZM4.5 15a3 3 0 1 0 0 6h15a3 3 0 1 0 0-6h-15Zm11.25 3.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5ZM19.5 18a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" clip-rule="evenodd"/>',
  HeroIcons.share:
  ...
  HeroIcons.square2Stack:
      '<path d="M16.5 6a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v7.5a3 3 0 0 0 3 3v-6A4.5 4.5 0 0 1 10.5 6h6Z"/> <path d="M18 7.5a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3h-7.5a3 3 0 0 1-3-3v-7.5a3 3 0 0 1 3-3H18Z"/>',
  HeroIcons.square3Stack3d:
  ...
  HeroIcons.tv:
      '<path d="M19.5 6h-15v9h15V6Z"/> <path fill-rule="evenodd" d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v11.25C1.5 17.16 2.34 18 3.375 18H9.75v1.5H6A.75.75 0 0 0 6 21h12a.75.75 0 0 0 0-1.5h-3.75V18h6.375c1.035 0 1.875-.84 1.875-1.875V4.875C22.5 3.839 21.66 3 20.625 3H3.375Zm0 13.5h17.25a.375.375 0 0 0 .375-.375V4.875a.375.375 0 0 0-.375-.375H3.375A.375.375 0 0 0 3 4.875v11.25c0 .207.168.375.375.375Z" clip-rule="evenodd"/>',
  HeroIcons.underline:
